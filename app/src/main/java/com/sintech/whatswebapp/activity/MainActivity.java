...
import com.sintech.whatswebapp.activity.stylishfonts.StylishFontsActivity;
import com.sintech.whatswebapp.activity.whatsappsticker.StickerPack;
import com.sintech.whatswebapp.activity.whatsappsticker.StickerPackDetailsActivity;
import com.sintech.whatswebapp.activity.whatsappsticker.StickerPackListActivity;
import com.sintech.whatswebapp.activity.whatsappsticker.StickerPackLoader;
import com.sintech.whatswebapp.activity.whatsappsticker.StickerPackValidator;
...
// Returns an intent object that you use to check for an update.
        ...
        appUpdateInfoTask.addOnSuccessListener(appUpdateInfo -> {
            if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                ...
                // Request the update.
                try{
                    appUpdateManager.startUpdateFlowForResult(appUpdateInfo,AppUpdateType.IMMEDIATE,MainActivity.this,6969);
